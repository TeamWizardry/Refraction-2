...
public class ItemLaserPen extends ItemMod {
	...
	public void onUsingTick(ItemStack stack, EntityLivingBase player, int count) {
		...
		new Beam(playerVec, player.getLook(1), RANGE, new Color(0x20FF0000, true), Utils.createUUID(player.getName()))
				.addEntityToSkip(player.getUniqueID())
				.spawn(player.getEntityWorld());
	}
}
