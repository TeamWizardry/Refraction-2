...
@Mod(
		...
		dependencies = "required-before:librarianlib"
)
public class Refraction {
	...
	@SidedProxy(clientSide = "com.teamwizardry.refraction.ClientProxy", serverSide = "com.teamwizardry.refraction.CommonProxy")
